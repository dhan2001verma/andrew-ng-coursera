...
A1 = [ones(m,1), sigmoid(X_nn * Theta1')];
O = sigmoid(A1 * Theta2');

% given matrix of predictions, compute J
J = J + (-1/m) * sum( ( (y_nn .* log(O)) + ( (1 .- y_nn) .* log(1 .- O) ) ) (:) );
